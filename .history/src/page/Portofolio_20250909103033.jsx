    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-3 w-full h-[78vh] overflow-hidden">
          ...
          <motion.div
            ...
            custom={13}
          >
            {/* Wrapper foto biar crossfade smooth */}
            <div className="relative w-[31vw] h-auto">
      ...
      <section className="w-full h-[100vh] pt-12 font-jakarta">
        ...
        <div className="px-20 mt-8">
          {/* Render project hanya kalau ada */}
          {selected.project && selected.project.length > 0 ? (
            <AnimatePresence mode="wait">
              <motion.div
                key={selected.project[0].id}
              ...
              >
                <img
                  ...
                  className="w-[40vw] rounded-lg shadow-lg"
                />
              </motion.div>
            </AnimatePresence>
          ) : (
            <p className="text-gray-500">Belum ada project untuk {selected.name}</p>
          )}
        </div>
      </section>
    </>
