...
export default function Portofolio({id}) {
 ...
 <motion.a
      ...
      className="relative flex items-center rounded-full bg-green-500 overflow-hidden w-40 h-12 group"
    >
      {/* Arrow Circle */}
      <motion.div
        className="absolute left-0 flex items-center justify-center w-12 h-12 bg-white rounded-full"
        whileHover={{ x: 4 }} // geser dikit aja, biar nggak goyang parah
      ...
      {/* Text Reveal */}
      <motion.span
        className="absolute left-12 text-white font-medium"
