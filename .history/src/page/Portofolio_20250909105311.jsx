                ...
                <div className="w-full flex justify-center items-center">
                    ...
                    <div className="bg-black rounded-lg p-4 w-[50%] flex gap-6">
                        ...
                        <div>
                            ...
                            <div>
                                <motion.a
      href="https://contoh.com" // ganti link tujuan
      target="_blank"
      rel="noopener noreferrer"
      initial={{ width: "3rem" }} // default: cuma bulat
      whileHover={{ width: "10rem" }} // hover: melebar
      transition={{ type: "spring", stiffness: 200, damping: 20 }}
      className="flex items-center overflow-hidden rounded-full bg-green-500"
    >
      {/* Arrow circle */}
      <motion.div
        className="flex items-center justify-center w-12 h-12 bg-white rounded-full shrink-0"
        whileHover={{ x: 8 }} // geser dikit pas hover
        transition={{ type: "spring", stiffness: 300, damping: 15 }}
      >
        <FiArrowRight className="text-black text-xl" />
      </motion.div>

      {/* Text muncul dengan animasi */}
      <motion.span
