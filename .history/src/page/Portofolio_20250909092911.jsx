...
export default function Portofolio({id}) {
    ...
    return (
        <section className="w-full">
            {/* Upper */}
            <div className="flex justify-between w-fit px-16 pt-4">
                <div className="text-2xl font-medium border-b">
                    <h1>It's Me</h1>
                </div>
            ...
            {/* Content */}
                <div className="grid grid-cols-3 w-full h-[78vh] overflow-hidden">
                    ...
                    {/* Right */}
                        <div className="col-span-1 flex justify-center items-center h-[80%]">
            ...
            {/* Content End */}
            <div className="inline-block bg-black w-full h-20">
                    </div>
        </section>
    );
};