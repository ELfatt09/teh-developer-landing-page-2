                        ...
                        <div className="col-span-2 px-12">
                            <div className="space-y-4">
                                <div className="text-4xl">
                                    <h1 className="font-">Hello! <span className="font-bold">I'm {selected.name}</span></h1>
                                </div>

                                <div className="flex items-center gap-4">
                                    <span className="inline-block h-[.5px] w-16 bg-black"></span>
                                    <h1 className="flex items-center gap-4">{selected.role} <PiSparkleFill /></h1>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div>
                                        <a download={selected.cv} href="">Download CV</a>
                                    </div>
                                </div>
                            </div>
                        </div>
