    ...
    >
      ...
      <div className="flex justify-between px-16 pt-4">
        ...
        <div className="flex gap-4">
          <motion.div className="border-t-2" variants={fadeInUp} custom={2}>
            <motion.h1 className="font-bold text-xl" variants={fadeInUp}>
              About Me
            </motion.h1>
            <motion.p
              className="w-full max-w-[10rem] text-gray-500"
              variants={fadeInUp}
              custom={3}
            >
              {selected.about}
          ...
          <motion.div className="border-t-2" variants={fadeInUp} custom={4}>
            <motion.h1 className="font-bold text-xl" variants={fadeInUp}>
              Contact Me
            </motion.h1>
            <motion.h2
                ...
                <div className="w-full flex justify-center items-center">
                    ...
                    <div className="bg-black rounded-lg p-4 w-[50%] flex gap-6">
                        ...
                        <div>
                            ...
                            <div>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore eaque necessitatibus quae eligendi magni ad ipsa veniam iste maxime ipsum atque, pariatur, odit porro expedita facilis dignissimos veritatis natus fuga fugit. Fugiat reprehenderit nihil sapiente dolor eum? Dolor, repudiandae maxime, praesentium quis accusantium excepturi quo nemo veniam aut eum assumenda?</p>
                            </div>
                        </div>
                    </div>
                </div>
