...
<AnimatePresence mode="wait">
  <motion.div
    key={selected.id + "-text"} // penting! biar re-render tiap ganti orang
  ...
  >
    ...
    <p className="text-2xl w-full max-w-2/3">{selected.quotes}</p>
  </motion.div>
</AnimatePresence>
          ...
          <LuSparkle className="text-white" /> back-end dev
            ...
            <section className="w-full h-[100vh] pt-12 font-jakarta">
                ...
                <div>
                    ...
                    <div>
                        <div>
                            <img src={selected.project[0].picture} alt="" />
                        </div>
                    </div>
                </div>
            </section>
