...
export default function Portofolio({id}) {
    ...
    >
      ...
      {/* About Me */}
      <motion.a
        href="#portfolio" // ganti ke id section portofolio lo
        className="relative flex items-center gap-2 border-t-2 group overflow-hidden"
        whileHover="hover"
      >
        <motion.div
        ...
        <motion.div
          className="pl-6" // kasih space biar arrow nggak nabrak text
          variants={{
            initial: { x: 0 },
            hover: { x: 8 },
          }}
        ...
        >
          ...
          <p className="w-full max-w-[10rem] text-gray-500">{selected.about}</p>
        </motion.div>
      </motion.a>
      ...
      >
        ...
        >
          ...
          <h2 className="w-full max-w-[10rem] text-gray-500">
            {selected.mail}
          </h2>
        </motion.div>
      </motion.a>
