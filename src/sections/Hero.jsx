...
function Hero() {
return (
    <div id='home' className="w-full py-10 mt-10 font-jakarta text-text">
        <div className="flex flex-col lg:flex-row w-full h-full justify-center items-start space-y-20">
            <div className="w-full lg:w-1/2 px-5 md:px-20 flex flex-col justify-center items-center lg:items-start lg:justify-start space-y-6 md:space-y-12">
                <h1 className="text-4xl text-center lg:text-start md:text-6xl tracking-tight font-bold leading-[1.1] ">
                    Punya Website Kini Sesantai <br />
                    <span className='text-primary'>
                        Menikmati Teh
                    </span>
                </h1>
                <p className="text-base md:text-xl font-semibold text-text-secondary w-full max-w-3/4 text-center md:text-start">
                ...
                <Link to="/contact" className="w-fit px-4 py-2 md:px-7 md:py-3 bg-primary hover:font-bold ease-in-out text-white rounded-lg font-semibold text:base md:text-xl hover:bg-primary/80 transition-all duration-500">Layanan Kami</Link>
            </div>
