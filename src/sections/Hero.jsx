...
return (
    <div className="w-full py-10 font-jakarta">
        <div className="flex flex-col lg:flex-row w-full h-full justify-center items-start space-y-20">
            <div className="w-full lg:w-1/2 px-5 md:px-20 flex flex-col justify-center items-center md:justify-start space-y-6 md:space-y-14">
            ...
            <div className="w-full lgw-1/2 h-full px-5 md:px-20 flex flex-col  items-end">
