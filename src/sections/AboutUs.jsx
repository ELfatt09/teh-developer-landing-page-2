...
return (
    <SectionWrapper id="about">
        ...
        <div className='w-full lg:w-fit max-w-4xl flex flex-col justify-end items-end tracking-[-3%] space-y-9 text-center lg:text-end '>
            ...
            <div className='w-full flex flex-row space-x-5'>
                ...
                <div className='w-1 h-content hidden lg:block bg-primary'></div>
            </div>
...
function Item({ children }) {
    return (
        <li className='text-gray-500 w-full text-sm md:text-xl flex flex-row items-center gap-2 text-start'>
